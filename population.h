...
/**
   ...
   * \param [in] genotype получается путем декодирования по следующим правилам:
    ...
    *    2) Если оба генна доминантны то предпочтение отдается более приспособленной особи;
...
public:
    ...
    void set_zigota(double *, bool); //Устанавливает значения best_parent и bed_parent. В качестве аргумент - одномерный массив и flag
                                                                                        //true - best; false - bed
